resource "local_file" "hosts_cfg" {
  content = templatefile("hosts.tpl",
    {
      server1 = aws_instance.Docker-swarm-master-1.0.public_ip
      server2 = aws_instance.Docker-swarm-master-2-and-3.0.public_ip
      server3 = aws_instance.Docker-swarm-master-2-and-3.1.public_ip
